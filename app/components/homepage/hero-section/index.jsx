    ...
    <section className="relative flex flex-col items-center justify-between py-4 lg:py-12">
      ...
      <div className="grid grid-cols-1 items-start lg:grid-cols-2 lg:gap-12 gap-y-8">
        <div className="order-2 lg:order-1 flex flex-col items-start justify-center p-2 pb-20 md:pb-10 lg:pt-10">
          ...
          <p className="mt-6 rounded-md border border-[#273b7a] bg-[#0f1a3a80] px-4 py-3 text-sm md:text-base text-gray-200">
            <span className="text-[#16f2b3] font-semibold">Stripe Experience:</span> Production work on
            payment authorization, capture, refunds, subscriptions, and webhook-based reconciliation.
          </p>
          ...
          <div className="overflow-hidden border-t-[2px] border-indigo-900 px-4 lg:px-8 py-4 lg:py-8">
            <code className="font-mono text-xs md:text-sm lg:text-base">
              ...
              <div className="ml-4 lg:ml-8 mr-2">
                ...
                <span className="text-gray-400">{` ['`}</span>
                <span className="text-amber-300">{showcaseSkills.join("', '")}</span>
                <span className="text-gray-400">{`'],`}</span>
              </div>
              <div>
                <span className="ml-4 lg:ml-8 mr-2 text-white">stripeExpertise:</span>
